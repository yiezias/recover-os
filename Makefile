...
OBJS=$(BUILD_DIR)/main.o $(BUILD_DIR)/debug.o $(BUILD_DIR)/print.o $(BUILD_DIR)/string.o \
     ...
     $(BUILD_DIR)/switch.o $(BUILD_DIR)/timer.o $(BUILD_DIR)/ide.o $(BUILD_DIR)/fs.o


CC=gcc
LD=ld

LIB=-I lib -I device -I kernel -I task -I fs
...
mkfs/mkfs: mkfs/mkfs.c
	$(CC) -W -Wall -Wstrict-prototypes -Wmissing-prototypes $(LIB) $< -o $@
